...
function Hero() {
  return (
    ...
    <div className='h-screen w-full  bg-red-200 relative '>  
      ...
      <MainCarousal/>
      <div className='w-full   absolute top-0 translate-y-[50vh]'>
       <div className=' w-full max-w-screen-xl mx-auto py-8 px-20 backdrop-blur-lg bg-white/10 rounded-lg'>
      ...
      <div className='w-full h-fit py-10 flex items-center justify-center max-w-screen-xl mx-auto font-semibold text-lg font-poppins'>
      ...
      <div className='w-full h-[337px] flex justify-center bg-cover bg-center items-center overflow-hidden bg-black relative'
       style={{ backgroundImage: `url(${gem})` }}>
        ...
        <h2 className='text-white font-poppins text-4xl  font-normal tracking-widest '>
